...
int ValidateVersions(string[] args)
{
    try
    {
        string csprojPath = GetArgValue(args, "--csproj", "-c", "src/HuduCommunityBot/HuduCommunityBot.csproj") ?? "src/HuduCommunityBot/HuduCommunityBot.csproj";
...
{
    Console.WriteLine(@"
HuduCommunityBot Version Manager - Synchronizes .csproj and CHANGELOG versions
...
VALIDATE OPTIONS:
  --csproj, -c <path>       Path to .csproj file (default: src/HuduCommunityBot/HuduCommunityBot.csproj)
