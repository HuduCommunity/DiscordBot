...
public class StatusMonitorConfig
{
    ...
    public void Validate()
    {
        ...
        {
            if (ChannelId == 0)
                throw new InvalidOperationException("StatusMonitorConfig: When enabled, ChannelId must be a valid Discord channel ID (non-zero). Current value: 0. Check HUDUCOMMUNITYBOT_Bot__StatusMonitor__ChannelId environment variable.");
