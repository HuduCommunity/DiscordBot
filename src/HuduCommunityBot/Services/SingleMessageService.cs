...
public class SingleMessageService
{
    ...
    private async Task<bool> EnsureSchemaInitializedAsync(HuduCommunityBotContext db)
    {
    ...
    private static async Task<bool> TableExistsAsync(HuduCommunityBotContext db, string tableName)
    {
    ...
    private static async Task<bool> TableColumnExistsAsync(HuduCommunityBotContext db, string tableName, string columnName)
    {
        var connection = db.Database.GetDbConnection();
        var closeWhenDone = connection.State != System.Data.ConnectionState.Open;
    ...
    private static async Task EnsureColumnExistsAsync(HuduCommunityBotContext db, string tableName, string columnName, string sqlTypeDefinition)
    {
    ...
    private static async Task CreateMissingSingleMessageSchemaAsync(HuduCommunityBotContext db)
    {
