...
public class DiscordBotService
{
    ...
    private Task LogAsync(LogMessage log)
    {
        ...
        {
            _logger.LogDebug("[{BotName}] {Source}: {Message}", "HuduCommunityBot", log.Source, downgradedMessage);
            return Task.CompletedTask;
        }
        ...
        _logger.Log(logLevel, log.Exception, "[{BotName}] {Source}: {Message}", "HuduCommunityBot", log.Source, message);
        return Task.CompletedTask;
    }
