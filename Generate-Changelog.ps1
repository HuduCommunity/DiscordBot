...
$csprojContent = Get-Content "src/HuduCommunityBot/HuduCommunityBot.csproj" -Raw
...
$newChangelog = "# Changelog`n`nAll notable changes to HuduCommunityBot will be documented in this file.`n`nThe format is based on [Keep a Changelog](https://keepachangelog.com/en/1.0.0/),`nand this project adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).`n`n$changelogEntry"
